//! Junita Fuchsia Platform
//!
//! Scenic compositor integration and Vulkan rendering for Fuchsia OS.
//!
//! This crate implements the `junita_platform` traits for Fuchsia,
//! providing touch/mouse input, lifecycle management, and window handling
//! via Scenic and FIDL.
//!
//! # Architecture
//!
//! Fuchsia uses a component-based architecture where Junita integrates through:
//!
...
pub use junita_fuchsia_zircon as zircon;
pub use junita_fidl as fidl;
pub use junita_fuchsia_async as fuchsia_async;
...
impl FuchsiaPlatform {
    ...
    pub fn with_placeholder() -> Result<Self, junita_platform::PlatformError> {
        Err(junita_platform::PlatformError::Unsupported(
