...
//! # Architecture
//!
//! Scenic is Fuchsia's graphics composition system. Junita integrates via:
//!
...
pub mod manifest {
    ...
    /// Required capabilities for a Junita app on Fuchsia
    ...
    /// Generate a basic component manifest for a Junita app
