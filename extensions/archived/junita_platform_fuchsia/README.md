...
Fuchsia OS platform support for the Junita UI framework.

## Overview

This crate provides Fuchsia-specific implementations of the `junita_platform` traits:
...
fx set core.x64 --with //third_party/junita
fx build
```
