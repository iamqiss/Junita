...
//!              │
//!              ▼ (C FFI)
//! Swift: junita_ios_native_call(ns, name, argsJson)
//!              │
//!              ▼
//! JunitaNativeBridge.shared.callNative(...)
//!              │
//!              ▼
...
//!
//! ```swift
//! public final class JunitaNativeBridge {
//!     public static let shared = JunitaNativeBridge()
...
//! }
//!
//! @_cdecl("junita_ios_native_call")
//! public func junitaIOSNativeCall(
//!     ns: UnsafePointer<CChar>,
//!     name: UnsafePointer<CChar>,
//!     args: UnsafePointer<CChar>
//! ) -> UnsafeMutablePointer<CChar> {
//!     let result = JunitaNativeBridge.shared.callNative(
...
//! }
//!
//! @_cdecl("junita_free_string")
//! public func junitaFreeString(ptr: UnsafeMutablePointer<CChar>) {
//!     free(ptr)
//! }
//! ```
...
/// Returns a C string containing JSON result (caller must free with `junita_free_string`).
...
/// Swift's `junita_free_string` takes precedence. When building
/// without Swift (e.g., for testing), this provides a fallback
/// that uses libc free.
#[no_mangle]
pub extern "C" fn junita_free_string(ptr: *mut c_char) {
    if !ptr.is_null() {
...
impl IOSNativeBridgeAdapter {
    ...
    ///
    /// # Arguments
    /// * `call_fn` - Function pointer to `junita_ios_native_call` from Swift
...
/// junita_set_native_call_fn(junita_ios_native_call)
/// ```
///
/// # Safety
///
...
#[no_mangle]
pub extern "C" fn junita_set_native_call_fn(call_fn: IOSNativeCallFn) {
    unsafe {
...
#[no_mangle]
pub extern "C" fn junita_native_bridge_is_ready() -> bool {
