...
use junita_platform::{ControlFlow, Event, EventLoop, PlatformError};
...
impl EventLoop for IOSEventLoop {
        ...
        F: FnMut(Event, &Self::Window) -> ControlFlow + 'static,
    {
        ...
        //
        // The actual integration happens in the IOSApp::run() in junita_app
        ...
        Err(PlatformError::Unsupported(
            "iOS event loop is managed by UIKit. Use IOSApp::run() from junita_app instead."
                .to_string(),
        ))
    }
}
