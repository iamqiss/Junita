...
iOS platform implementation for Junita UI.

## Overview

`junita_platform_ios` provides UIKit integration, Metal rendering, and touch input handling for iOS and iPadOS applications.
...
```rust
use junita_platform_ios::ios_main;
