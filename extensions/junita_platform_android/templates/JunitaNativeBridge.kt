/**
 * Junita Native Bridge for Android
 *
 ...
 * JunitaNativeBridge.registerDefaults(context)
 *
 * // Or register custom handlers
 * JunitaNativeBridge.register("myapi", "my_function") { args ->
 *     // args is JSONArray
 *     "result"
 * }
 * ```
...
object JunitaNativeBridge {
    ...
    fun registerDefaults(context: Context) {
        ...
        register("clipboard", "copy") { args ->
            ...
            clipboard?.setPrimaryClip(ClipData.newPlainText("Junita", text))
            null
        }
