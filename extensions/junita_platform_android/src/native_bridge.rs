...
//!              │
//!              ▼ (JNI)
//! Kotlin: JunitaNativeBridge.callNative(ns, name, argsJson)
//!              │
//!              ▼
...
pub struct AndroidNativeBridgeAdapter {
    ...
    vm: JavaVM,
    /// Global reference to JunitaNativeBridge class
...
impl AndroidNativeBridgeAdapter {
    ...
    pub fn new(vm: JavaVM, env: &mut JNIEnv) -> Result<Self, jni::errors::Error> {
        ...
        let class = env.find_class("com/junita/JunitaNativeBridge")?;
...
impl PlatformAdapter for AndroidNativeBridgeAdapter {
    fn call(
        ...
        // Call JunitaNativeBridge.callNative(namespace, name, argsJson) -> String
        let result = env
            .call_static_method(
                &self.bridge_class,
                "callNative",
