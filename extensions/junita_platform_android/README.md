...
Android platform implementation for Junita UI.

## Overview

`junita_platform_android` provides native Android integration using the NDK, including activity lifecycle, touch input, and GPU rendering via Vulkan.
...
```rust
use junita_platform_android::android_main;
