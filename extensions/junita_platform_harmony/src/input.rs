...
//!
//! Converts XComponent touch events to Junita input events.

use junita_platform::{InputEvent, TouchEvent};
...
/// Convert a HarmonyOS touch to a Junita input event
...
/// Convert OH_NativeXComponent_TouchEvent to Junita Touch
///
