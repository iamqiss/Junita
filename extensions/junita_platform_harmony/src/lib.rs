//! Junita HarmonyOS Platform
//!
//! XComponent integration and Vulkan/GLES rendering for HarmonyOS.
//!
//! This crate implements the `junita_platform` traits for HarmonyOS,
//! providing touch input, lifecycle management, and window handling
//! via XComponent and N-API.
//!
//! # Architecture
//!
//! HarmonyOS uses ArkUI for native development. Junita integrates through:
//!
...
//!
//! ```ignore
//! use junita_app::harmony::HarmonyApp;
//!
