...
Desktop platform implementation for Junita UI.

## Overview

`junita_platform_desktop` provides windowing, input handling, and event loop implementation for desktop platforms (macOS, Windows, Linux) using [winit](https://github.com/rust-windowing/winit).
...
use junita_platform::{Platform, WindowConfig};
