//! Desktop input conversion (winit -> junita_platform)
...
/// Convert winit mouse button to junita MouseButton
...
/// Convert winit element state to junita KeyState
...
/// Convert winit modifiers to junita Modifiers
...
/// Convert winit key to junita Key
...
/// Convert winit keyboard event to junita InputEvent
...
/// Convert winit touch event to junita InputEvent
...
/// Convert mouse move to junita InputEvent
pub fn mouse_moved(x: f32, y: f32) -> InputEvent {
    InputEvent::Mouse(MouseEvent::Moved { x, y })
}

/// Convert mouse button press to junita InputEvent
...
/// Convert mouse button release to junita InputEvent
...
/// Convert scroll event to junita InputEvent
