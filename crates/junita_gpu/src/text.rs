//! Text rendering support for junita_gpu
//!
//! This module provides integration between junita_text's TextRenderer
...
impl TextRenderingContext {
    ...
    pub fn load_font(&mut self, path: &std::path::Path) -> Result<(), junita_text::TextError> {
    ...
    pub fn load_font_data(&mut self, data: Vec<u8>) -> Result<(), junita_text::TextError> {
    ...
    pub fn set_font(&mut self, font: junita_text::FontFace) {
    ...
    pub fn prepare_text(
        ...
        font_size: f32,
        color: [f32; 4],
    ) -> Result<Vec<GpuGlyph>, junita_text::TextError> {
    ...
    pub fn prepare_text_with_style(
        ...
        if !wrap {
            options.line_break = junita_text::LineBreakMode::None;
        }
