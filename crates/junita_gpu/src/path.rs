...
use junita_core::{Brush, Color, Gradient, Path, PathCommand, Point, Stroke, Vec2};
...
/// Convert junita_core Path to lyon path events
...
pub struct PathBrushInfo {
    ...
    pub gradient_stops: Option<Vec<junita_core::GradientStop>>,
...
pub fn tessellate_stroke(path: &Path, stroke: &Stroke, brush: &Brush) -> TessellatedPath {
    ...
    options = options.with_line_cap(match stroke.cap {
        junita_core::LineCap::Butt => lyon::lyon_tessellation::LineCap::Butt,
        junita_core::LineCap::Round => lyon::lyon_tessellation::LineCap::Round,
        junita_core::LineCap::Square => lyon::lyon_tessellation::LineCap::Square,
    });

    // Convert line join
    options = options.with_line_join(match stroke.join {
        junita_core::LineJoin::Miter => lyon::lyon_tessellation::LineJoin::Miter,
        junita_core::LineJoin::Round => lyon::lyon_tessellation::LineJoin::Round,
        junita_core::LineJoin::Bevel => lyon::lyon_tessellation::LineJoin::Bevel,
    });
