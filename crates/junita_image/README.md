...
Image loading and rendering for Junita UI.

## Overview

`junita_image` provides image loading, decoding, and rendering utilities for the Junita UI framework.
...
```rust
use junita_image::{ImageData, ImageSource, ObjectFit};
...
```rust
use junita_image::ObjectPosition;
