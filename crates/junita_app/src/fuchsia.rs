...
//!
//! Provides a unified API for running Junita applications on Fuchsia OS.
//!
//! # Example
//!
//! ```ignore
...
use junita_platform_fuchsia::FuchsiaPlatform;
...
/// Fuchsia application runner
///
/// Provides a simple way to run a Junita application on Fuchsia OS
/// with automatic event handling and rendering via Scenic.
pub struct FuchsiaApp;

impl FuchsiaApp {
    /// Run a Fuchsia Junita application
    ///
    ...
    where
        ...
        E: ElementBuilder + 'static,
    {
        Err(JunitaError::PlatformUnsupported(
