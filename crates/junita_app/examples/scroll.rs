...
//!
//! Run with: cargo run -p junita_app --example scroll --features windowed

use junita_app::prelude::*;
use junita_app::windowed::{WindowedApp, WindowedContext};
use junita_core::State;
use junita_layout::prelude::{ButtonState, NoState, Scroll, ScrollPhysics, SharedScrollPhysics};
...
fn main() -> Result<()> {
    ...
    let config = WindowConfig {
        title: "Junita Scroll Example".to_string(),
        width: 800,
        height: 600,
        resizable: true,
        ..Default::default()
