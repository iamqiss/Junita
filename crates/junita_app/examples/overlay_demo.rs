...
//!
//! Run with: cargo run -p junita_app --example overlay_demo --features windowed

use junita_app::prelude::*;
use junita_app::windowed::{WindowedApp, WindowedContext};
use junita_layout::stateful::{ButtonState, SharedState};
...
fn main() -> Result<()> {
    ...
    let config = WindowConfig {
        title: "Junita Overlay Demo".to_string(),
        width: 900,
        height: 700,
        resizable: true,
        ..Default::default()
...
fn overlay_button(label: &str) -> junita_layout::widgets::Button {
