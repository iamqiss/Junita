...
//!
//! This example demonstrates how to create a windowed Junita application
...
//!
//! Run with: cargo run -p junita_app --example windowed --features windowed

use junita_app::prelude::*;
use junita_app::windowed::{WindowedApp, WindowedContext};
use junita_core::{Shadow, Transform};
use junita_layout::stateful::ButtonState;
...
fn main() -> Result<()> {
    ...
    let config = WindowConfig {
        title: "Junita Windowed Example".to_string(),
        width: 800,
        height: 600,
        resizable: true,
        ..Default::default()
        ...
        .child(
            stateful::<ButtonState>()
                ...
                .on_state(|ctx| {
                    ...
                    div()
                        .child(
                            img("crates/junita_app/examples/assets/original-c4197a5bf25a4356aa2bac6f82073eb2.webp")
                                .w(120.0)
                                .h(80.0)
                                .cover()
                                .shadow(shadow)
