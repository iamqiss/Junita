...
//!
//! Run with: cargo run -p junita_app --example markdown_demo --features windowed

use junita_app::prelude::*;
use junita_app::windowed::{WindowedApp, WindowedContext};
use junita_core::{Color, SignalId, State};
use junita_layout::markdown::markdown_light;
use junita_layout::prelude::NoState;
...
This is a **live preview** markdown editor built with Junita.
...
![Sample Image](crates/junita_app/examples/assets/original-c4197a5bf25a4356aa2bac6f82073eb2.webp)
...
Junita supports footnotes[^1] for adding references and notes[^2].
