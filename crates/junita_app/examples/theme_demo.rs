//! Theme System Demo
//!
//! This example demonstrates the Junita theming system capabilities:
...
//!
//! Run with: cargo run -p junita_app --example theme_demo --features windowed

use junita_app::prelude::*;
use junita_app::windowed::{WindowedApp, WindowedContext};
use junita_core::{Color, Transform};
...
fn main() -> Result<()> {
    ...
    let config = WindowConfig {
        title: "Junita Theme Demo".to_string(),
        width: 1000,
        height: 700,
        resizable: true,
        ..Default::default()
