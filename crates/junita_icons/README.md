...
[Lucide](https://lucide.dev/) icon library for Junita UI.

## Overview

`junita_icons` provides 1000+ icons from the Lucide icon set as compile-time constants. Icons are stored as SVG path strings for zero runtime cost.
...
```rust
use junita_icons::{icons, to_svg, to_svg_colored};
