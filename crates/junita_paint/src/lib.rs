//! Junita Paint/Canvas API
//!
//! A 2D drawing API for custom graphics, similar to HTML Canvas or Skia.
//! All core types are unified with junita_core for seamless integration
...
//!
//! ```ignore
//! use junita_paint::{PaintContext, Color, Rect};
//! use junita_core::DrawContext;
//!
...
// Re-export modules
pub mod color {
    //! Color types - re-exported from junita_core
    pub use junita_core::Color;
}

// ─────────────────────────────────────────────────────────────────────────────
// Core type re-exports from junita_core (unified type system)
// ─────────────────────────────────────────────────────────────────────────────
