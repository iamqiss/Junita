...
//!
//! Core types are re-exported from junita_core for unified type system.
//! junita_paint-specific convenience types are defined here.

// Re-export core types
pub use junita_core::{CornerRadius, Point, Rect, Shadow, Size};
