//! Junita Debugger - Visual debugger for UI recordings
//!
...
//!
//! Layout based on Phase 12 of the junita_recorder implementation plan.
...
#[derive(Parser, Debug)]
#[command(name = "junita-debugger")]
#[command(about = "Visual debugger for Junita UI recordings")]
#[command(version)]
struct Args {
...
fn main() -> Result<()> {
    ...
    log::info!("Starting Junita Debugger");
