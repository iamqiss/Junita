...
Component library for Junita UI - shadcn/ui-style themed components.

## Overview

`junita_cn` provides a comprehensive set of production-ready UI components built on top of `junita_layout`. Inspired by [shadcn/ui](https://ui.shadcn.com/), it offers beautifully designed, accessible components with consistent theming.
        ...
        .child(
            card()
                .child(card_header()
                    ...
                    .child(card_description("Get started with Junita")))
                .child(card_content()
