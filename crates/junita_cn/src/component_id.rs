...
//! that can be used with stateful systems without depending on junita_app.
//!
//! # Usage
//!
//! ```ignore
//! use junita_cn::component_id;
//!
...
///
/// ```ignore
/// use junita_cn::component_type_id;
///
/// struct MyButton;
///
...
///
/// ```ignore
/// use junita_cn::{impl_component_id, ComponentId};
///
/// struct MyCard;
