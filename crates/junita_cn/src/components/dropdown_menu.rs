...
use junita_layout::element::{CursorStyle, ElementBounds, RenderProps};
use junita_layout::motion::motion_derived;
use junita_layout::overlay_state::get_overlay_manager;
use junita_layout::prelude::*;
use junita_layout::stateful::{stateful_with_key, ButtonState, Stateful};
...
impl DropdownMenuBuilder {
    ...
    fn build_component(&self) -> DropdownMenu {
        ...
        let open_state: State<bool> =
            JunitaContextState::get().use_state_keyed(self.key.get(), || false);
