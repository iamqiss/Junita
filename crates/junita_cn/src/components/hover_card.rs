...
use junita_layout::element::RenderProps;
...
use junita_layout::widgets::overlay::{AnchorDirection, OverlayHandle, OverlayManagerExt};
...
fn show_hover_card_overlay(
    ...
    mgr.hover_card()
        ...
        .content(move || {
            ...
            if let Some(handle) = junita_layout::selector::query(&card_id) {
            ...
            div().child(
                junita_layout::motion::motion_derived(&motion_key_for_content)
