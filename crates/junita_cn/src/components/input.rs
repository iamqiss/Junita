...
//!
//! A themed wrapper around `junita_layout::TextInput` with consistent styling,
...
use junita_layout::widgets::text_input::{
    InputType, OnChangeCallback, SharedTextInputData, TextInput,
};
use junita_theme::{ColorToken, RadiusToken, SpacingToken, ThemeState, TypographyTokens};
...
impl Input {
    ...
    fn build_text_input(
        ...
        let mut input = junita_layout::widgets::text_input::text_input(&config.data)
...
impl Default for InputConfig {
    fn default() -> Self {
        Self {
            data: junita_layout::widgets::text_input::text_input_data(),
...
mod tests {
    use super::*;
    use junita_theme::TypographyTokens;
    ...
    fn test_input_builder() {
        init_theme();
        let data = junita_layout::widgets::text_input::text_input_data();
