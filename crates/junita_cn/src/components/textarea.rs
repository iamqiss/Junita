...
//!
//! A themed wrapper around `junita_layout::TextArea` with consistent styling,
...
use junita_layout::widgets::text_area::{
...
mod tests {
    ...
    fn test_textarea_builder() {
        init_theme();
        let state = junita_layout::widgets::text_area::text_area_state();
