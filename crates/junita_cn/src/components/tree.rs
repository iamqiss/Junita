...
use junita_animation::{AnimatedValue, SchedulerHandle, SpringConfig};
use junita_core::context_state::JunitaContextState;
use junita_core::{Color, SignalId, State};
    ...
    fn build_component(&self) -> TreeView {
        ...
        fn collect_states(
            ...
            let is_expanded: State<bool> =
                JunitaContextState::get().use_state_keyed(&state_key, || node.initially_expanded);
        ...
        let selected: State<Option<String>> = JunitaContextState::get()
