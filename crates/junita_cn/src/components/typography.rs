...
//!
//! Re-exports typography helpers from `junita_layout::typography` for use with the
//! junita_cn component library. These provide semantic text elements similar to HTML.
//!
//! # Headings
//!
//! ```ignore
...
// Re-export all typography helpers from junita_layout
pub use junita_layout::typography::{
    // Inline text helpers
    b,
    caption,
    chained_text,
