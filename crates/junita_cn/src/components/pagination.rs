...
fn build_nav_button<F>(
    ...
    text_secondary: junita_core::Color,
...
fn build_page_button<F>(
    ...
    font_size: f32,
    radius: f32,
    primary: junita_core::Color,
    primary_hover: junita_core::Color,
    surface_elevated: junita_core::Color,
    border: junita_core::Color,
    text_primary: junita_core::Color,
    text_secondary: junita_core::Color,
    on_click: F,
) -> impl ElementBuilder
where
        ...
        .on_state(move |ctx| {
            ...
            let (bg, text_color, border_color) = if is_current {
                ...
                match state {
                    ...
                    _ => (junita_core::Color::TRANSPARENT, text_secondary, border),
                }
            };
