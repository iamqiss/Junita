...
use junita_layout::widgets::overlay::{Corner, OverlayHandle, OverlayManagerExt};
...
fn get_enter_animation(corner: Corner) -> junita_animation::MultiKeyframeAnimation {
...
fn get_exit_animation(corner: Corner) -> junita_animation::MultiKeyframeAnimation {
    const SLIDE_DISTANCE: f32 = 100.0;
    match corner {
