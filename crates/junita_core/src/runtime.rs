...
/// The Junita reactive runtime - owns all reactive state, state machines, and event handling
pub struct JunitaReactiveRuntime {
    pub reactive: ReactiveGraph,
    pub fsm: FsmRuntime,
    pub events: EventDispatcher,
}

impl JunitaReactiveRuntime {
    pub fn new() -> Self {
        Self {
...
impl Default for JunitaReactiveRuntime {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    fn test_runtime_integration() {
        let mut runtime = JunitaReactiveRuntime::new();
