...
//! in the JUNITA canvas architecture. It adapts to the current layer type, providing
...
///
/// This is the primary interface for all drawing operations in JUNITA. It provides:
///
...
pub trait DrawContext {
    ...
    ///
    /// ```ignore
    /// use junita_3d::sdf::{SdfScene, SdfCodegen};
    /// use junita_core::{DrawContext, Sdf3DViewport, Rect};
    ///
    /// // Build an SDF scene
    ...
    ///
    /// ```ignore
    /// use junita_core::{DrawContext, ParticleSystemData, Rect};
    ///
