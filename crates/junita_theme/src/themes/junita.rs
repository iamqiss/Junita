//! Default Junita theme derived from Catppuccin design system
//!
...
/// Default Junita theme derived from Catppuccin
#[derive(Clone, Debug)]
pub struct JunitaTheme {
    scheme: ColorScheme,
    colors: ColorTokens,
...
impl JunitaTheme {
    ...
    pub fn bundle() -> ThemeBundle {
        ThemeBundle::new("Junita", Self::light(), Self::dark())
    }
}

impl Theme for JunitaTheme {
    fn name(&self) -> &str {
        "Junita"
    }
