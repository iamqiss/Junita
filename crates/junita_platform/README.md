...
Platform abstraction layer for Junita UI.

## Overview

`junita_platform` defines the traits and types for cross-platform windowing, input handling, and application lifecycle. Platform-specific implementations are provided by separate crates.
...
| Crate | Platforms |
|-------|-----------|
| `junita_platform_desktop` | macOS, Windows, Linux |
| `junita_platform_ios` | iOS, iPadOS |
| `junita_platform_android` | Android |
