//! Junita Platform Abstraction Layer
//!
...
//!
//! - `junita_platform_desktop` - Desktop platforms (macOS, Windows, Linux) using winit
//! - `junita_platform_android` - Android using NDK
//! - `junita_platform_ios` - iOS using UIKit (planned)
//!
//! # Example
//!
//! ```ignore
