...
//!
//! ```ignore
//! use junita_platform::assets::{AssetLoader, AssetPath};
//!
...
/// a way for libraries like junita_image to load assets without
...
///
/// ```ignore
/// let image_data = junita_platform::assets::load_asset("images/logo.png")?;
/// ```
...
mod tests {
    ...
    fn test_filesystem_loader() {
        ...
        let test_file = temp_dir.join("junita_test_asset.txt");
        let mut f = std::fs::File::create(&test_file).unwrap();
        f.write_all(b"Hello, Junita!").unwrap();
