            ...
            div()
                ...
                .child(
                    div()
                        .flex_col()
                        .gap_px(8.0)
                        .child(text("Sizes").size(14.0).weight(FontWeight::Medium).color(text_secondary))
                        .child(
                            div()
                                .flex_row()
                                .gap_px(16.0)
                ...
                .child(
                    div()
                        .flex_col()
                        .gap_px(8.0)
                        .child(text("Shapes").size(14.0).weight(FontWeight::Medium).color(text_secondary))
                        .child(
                            div()
                                .flex_row()
                                .gap_px(16.0)
                ...
                .child(
                    div()
                        .flex_col()
                        .gap_px(8.0)
                        .child(text("Fallback Initials").size(14.0).weight(FontWeight::Medium).color(text_secondary))
                        .child(
                            div()
                                .flex_row()
                                .gap_px(12.0)
                                ...
                                .child(cn::avatar().fallback("AB").lg().fallback_bg(primary.with_alpha(0.2)))
                ...
                .child(
                    div()
                        .flex_col()
                        .gap_px(8.0)
                        .child(text("Status Indicators").size(14.0).weight(FontWeight::Medium).color(text_secondary))
                        .child(
                            div()
                                .flex_row()
                                .gap_px(16.0)
                ...
                .child(
                    div()
                        .flex_col()
                        .gap_px(8.0)
                        .child(text("Avatar Group").size(14.0).weight(FontWeight::Medium).color(text_secondary))
                        .child(
                            div()
                                .flex_col()
                                .gap_px(12.0)
                                .child(
                                    cn::avatar_group()
                                        ...
                                        .child(cn::avatar().fallback("AB").fallback_bg(primary.with_alpha(0.2)))
                                        .child(cn::avatar().fallback("CD").fallback_bg(tertiary.with_alpha(0.2)))
                                        .child(cn::avatar().fallback("EF").fallback_bg(secondary.with_alpha(0.2))),
                                )
                                .child(
                                    div()
                                        .flex_row()
