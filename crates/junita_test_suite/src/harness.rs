...
use junita_layout::div::FontFamily;
...
impl TestHarness {
    ...
    pub fn prepare_text_with_font(
        ...
        use junita_layout::div::GenericFont as LayoutGenericFont;
        use junita_text::{GenericFont as TextGenericFont, TextAlignment};
    ...
    fn test_render_to_png() {
        ...
        let result = harness
            .run_test("simple_rect", |ctx| {
                ctx.ctx().fill_rect(
                    junita_core::Rect::new(100.0, 100.0, 200.0, 100.0),
                    8.0.into(),
                    Color::BLUE.into(),
                );
            })
