...
use junita_core::{Color, DrawContext, Path, Point, Rect, Stroke};
...
pub fn suite() -> TestSuite {
    ...
    suite.add("per_corner_rounded_rect", |ctx| {
        ...
        let corner_radius = junita_core::CornerRadius {
            top_left: 0.0,
            top_right: 20.0,
            bottom_right: 40.0,
            bottom_left: 10.0,
    ...
    suite.add("arc_large", |ctx| {
        ...
        let small_arc = Path::new().move_to(100.0, 150.0).arc_to(
            junita_core::Vec2::new(60.0, 60.0),
            0.0,
            false, // small arc
            true,
            200.0,
    ...
    suite.add("arc_sweep", |ctx| {
        ...
        let cw_arc = Path::new().move_to(100.0, 150.0).arc_to(
            junita_core::Vec2::new(50.0, 50.0),
            0.0,
            false,
            true, // clockwise
            200.0,
    ...
    suite.add("arc_elliptical", |ctx| {
        ...
        let ellipse_arc = Path::new().move_to(100.0, 150.0).arc_to(
            junita_core::Vec2::new(80.0, 40.0), // different radii
            0.0,
            false,
            true,
            300.0,
        ...
        let rotated_arc = Path::new().move_to(100.0, 220.0).arc_to(
            junita_core::Vec2::new(80.0, 40.0),
    ...
    suite.add("arc_pie_slice", |ctx| {
        ...
        let slice = Path::new()
            ...
            .arc_to(junita_core::Vec2::new(r, r), 0.0, false, true, x2, y2)
            .close();
