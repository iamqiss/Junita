...
pub fn suite() -> TestSuite {
        ...
        let ui = div()
            ...
            .child(
                div()
                    ...
                    .h(70.0)
                    .rounded(8.0)
                    .bg(Color::rgba(0.95, 0.3, 0.4, 1.0)),
            ) // Coral
            .child(
                div()
                    .w_full()
                    .h(70.0)
                    .rounded(8.0)
                    .bg(Color::rgba(0.3, 0.85, 0.5, 1.0)),
            ) // Mint
            .child(
                div()
                    .w_full()
                    .h(70.0)
                    .rounded(8.0)
                    .bg(Color::rgba(0.3, 0.5, 0.95, 1.0)),
            ) // Sky blue
            .child(
                div()
                    .w_full()
                    .h(70.0)
                    .rounded(8.0)
                    .bg(Color::rgba(0.95, 0.85, 0.3, 1.0)),
            ); // Gold
        ...
        let ui = div()
            ...
            .child(
                div()
                    ...
                    .h(80.0)
                    .rounded(8.0)
                    .bg(Color::rgba(0.3, 0.75, 0.6, 1.0)),
            ) // Flexible middle (teal)
            .child(
                div()
                    .w(80.0)
                    .h(80.0)
                    .rounded(8.0)
                    .bg(Color::rgba(0.5, 0.3, 0.9, 1.0)),
            ); // Fixed right (purple)
        ...
        let ui = div()
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .h(90.0)
                            .rounded(12.0)
                            .bg(Color::rgba(0.95, 0.35, 0.45, 1.0)),
                    ) // Coral
                    .child(
                        div()
                            .flex_grow()
                            .h(90.0)
                            .rounded(12.0)
                            .bg(Color::rgba(1.0, 0.65, 0.3, 1.0)),
                    ), // Orange
            )
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .h_full()
                            .rounded(12.0)
                            .bg(Color::rgba(0.95, 0.85, 0.35, 1.0)),
                    ) // Gold
                    .child(
                        div()
                            .flex_grow()
                            .h_full()
                            .rounded(12.0)
                            .bg(Color::rgba(0.35, 0.85, 0.55, 1.0)),
                    ), // Mint
            )
            ...
            .child(
                div()
                    ...
                    .h(60.0)
                    .rounded(12.0)
                    .bg(Color::rgba(0.35, 0.7, 0.95, 1.0)),
            ); // Sky blue
    ...
    suite.add("justify_content", |ctx| {
        ...
        c.push_transform(junita_core::Transform::translate(10.0, 10.0));
        tree1.render(c);
        c.pop_transform();
        ...
        c.push_transform(junita_core::Transform::translate(10.0, 95.0));
        tree2.render(c);
        c.pop_transform();
        ...
        c.push_transform(junita_core::Transform::translate(10.0, 180.0));
        tree3.render(c);
        c.pop_transform();
        ...
        c.push_transform(junita_core::Transform::translate(10.0, 265.0));
        tree4.render(c);
        c.pop_transform();
    });
    ...
    suite.add("card_component", |ctx| {
        ...
        // Center the card
        ctx.ctx()
            .push_transform(junita_core::Transform::translate(60.0, 60.0));
        tree.render(ctx.ctx());
    ...
    suite.add_glass("glass_card", |ctx| {
        ...
        c.fill_rect(
            junita_core::Rect::new(0.0, 0.0, 400.0, 350.0),
            0.0.into(),
        ...
        c.fill_circle(
            junita_core::Point::new(80.0, 80.0),
            70.0,
            Color::rgba(0.95, 0.35, 0.5, 1.0).into(),
        );
        c.fill_circle(
            junita_core::Point::new(320.0, 120.0),
            80.0,
            Color::rgba(0.3, 0.85, 0.7, 1.0).into(),
        );
        c.fill_circle(
            junita_core::Point::new(200.0, 280.0),
            60.0,
            Color::rgba(0.95, 0.75, 0.3, 1.0).into(),
        );
        c.fill_rect(
            junita_core::Rect::new(30.0, 200.0, 100.0, 100.0),
            16.0.into(),
        ...
        let card_ui = div().w(400.0).h(350.0).p_px(50.0).child(
            div()
                .w(300.0)
                .h(200.0)
    ...
    suite.add_glass("glass_layout_panels", |ctx| {
        ...
        c.fill_circle(
            junita_core::Point::new(100.0, 100.0),
            90.0,
            Color::rgba(0.9, 0.3, 0.5, 1.0).into(),
        );
        c.fill_circle(
            junita_core::Point::new(300.0, 250.0),
            100.0,
            Color::rgba(0.3, 0.8, 0.6, 1.0).into(),
        );
        c.fill_circle(
            junita_core::Point::new(200.0, 50.0),
            70.0,
    ...
    suite.add_glass("glass_material_api", |ctx| {
        ...
        c.fill_circle(
            junita_core::Point::new(300.0, 200.0),
            90.0,
            Color::rgba(0.3, 0.8, 0.5, 1.0).into(),
        );
        c.fill_circle(
            junita_core::Point::new(150.0, 280.0),
            70.0,
            Color::rgba(0.3, 0.5, 0.95, 1.0).into(),
        );
        c.fill_circle(
            junita_core::Point::new(280.0, 80.0),
            60.0,
            Color::rgba(0.95, 0.7, 0.2, 1.0).into(),
        );
    ...
    suite.add_glass("music_player", |ctx| {
        ...
        // Colorful shapes for blur effect
        c.fill_circle(
            junita_core::Point::new(80.0 * scale, 60.0 * scale),
            100.0 * scale,
            Color::rgba(0.95, 0.3, 0.5, 1.0).into(),
        );
        c.fill_circle(
            junita_core::Point::new(320.0 * scale, 120.0 * scale),
            90.0 * scale,
            Color::rgba(0.2, 0.8, 0.85, 1.0).into(),
        );
        c.fill_circle(
            junita_core::Point::new(180.0 * scale, 260.0 * scale),
            80.0 * scale,
            Color::rgba(1.0, 0.5, 0.2, 1.0).into(),
        );
        c.fill_circle(
            junita_core::Point::new(350.0 * scale, 240.0 * scale),
            60.0 * scale,
            Color::rgba(1.0, 0.85, 0.2, 1.0).into(),
        );
        c.fill_circle(
            junita_core::Point::new(50.0 * scale, 220.0 * scale),
            70.0 * scale,
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .justify_center()
                            .items_center()
                            .child(text("Junita UI 0.1.0").size(14.0 * scale).color(Color::rgba(1.0, 1.0, 1.0, 0.95)))
                    )
