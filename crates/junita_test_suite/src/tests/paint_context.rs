//! PaintContext tests
//!
//! Tests for the junita_paint PaintContext convenience API

use crate::runner::TestSuite;
use junita_core::{Color, DrawContext, Point, Rect, Stroke};
...
pub fn suite() -> TestSuite {
    ...
    suite.add("paint_translate", |ctx| {
        ...
        c.push_transform(junita_core::Transform::translate(100.0, 50.0));
        c.fill_rect(
    ...
    suite.add("paint_scale", |ctx| {
        ...
        c.push_transform(junita_core::Transform::translate(200.0, 150.0));
        c.push_transform(junita_core::Transform::scale(2.0, 1.5));
        c.fill_rect(
    ...
    suite.add("paint_rotate", |ctx| {
        ...
        c.push_transform(junita_core::Transform::translate(200.0, 150.0));
        c.push_transform(junita_core::Transform::rotate(0.3));
        c.fill_rect(
    ...
    suite.add("paint_combined_transforms", |ctx| {
        ...
        c.push_transform(junita_core::Transform::translate(200.0, 150.0));
        c.push_transform(junita_core::Transform::rotate(0.5));
        c.push_transform(junita_core::Transform::scale(1.5, 1.0));
