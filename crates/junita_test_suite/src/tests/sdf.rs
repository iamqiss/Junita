...
pub fn suite() -> TestSuite {
    ...
    suite.add("sdf_with_shadow", |ctx| {
        ...
        c.sdf_build(&mut |sdf| {
            ...
            sdf.shadow(
                shape,
                junita_core::Shadow::new(4.0, 4.0, 10.0, Color::BLACK.with_alpha(0.3)),
            );
    ...
    suite.add("sdf_button", |ctx| {
        ...
        c.sdf_build(&mut |sdf| {
            ...
            sdf.shadow(
                shape,
                junita_core::Shadow::new(0.0, 2.0, 4.0, Color::BLACK.with_alpha(0.2)),
            );
            sdf.fill(shape, Color::BLUE.into());
        });
    });
    ...
    suite.add("sdf_card_layered", |ctx| {
        ...
        c.sdf_build(&mut |sdf| {
            ...
            sdf.shadow(
                shape,
                junita_core::Shadow::new(0.0, 12.0, 24.0, Color::BLACK.with_alpha(0.1)),
            );
        });
        ...
        c.sdf_build(&mut |sdf| {
            ...
            sdf.shadow(
                shape,
                junita_core::Shadow::new(0.0, 4.0, 8.0, Color::BLACK.with_alpha(0.15)),
            );
        });
