...
use junita_core::AnimationAccess;
...
///
/// ```ignore
/// use junita_animation::{get_scheduler, AnimatedValue, SpringConfig};
///
...
///
/// ```ignore
/// use junita_animation::{AnimatedKeyframe, Keyframe, Easing};
///
...
///
/// ```ignore
/// use junita_animation::AnimatedTimeline;
///
/// // Create a timeline
