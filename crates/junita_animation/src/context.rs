...
//!
//! ```ignore
//! use junita_animation::context::AnimationContext;
...
//! ```
//!
//! # Combining with JunitaContext
//!
//! For full context functionality, combine both traits:
//!
//! ```ignore
//! use junita_core::JunitaContext;
//! use junita_animation::AnimationContext;
//!
//! fn my_component<C: JunitaContext + AnimationContext>(ctx: &C) {
