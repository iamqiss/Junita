...
mod ffi {
    #[no_mangle]
    pub extern "C" fn junita_spring_create(
        _stiffness: f32,
        _damping: f32,
        _mass: f32,
        _initial: f32,
    ...
    #[no_mangle]
    pub extern "C" fn junita_spring_set_target(_handle: *mut std::ffi::c_void, _target: f32) {
        // TODO: Implement
    }

    #[no_mangle]
    pub extern "C" fn junita_spring_value(_handle: *mut std::ffi::c_void) -> f32 {
        // TODO: Implement
        0.0
    }

    #[no_mangle]
    pub extern "C" fn junita_spring_velocity(_handle: *mut std::ffi::c_void) -> f32 {
        // TODO: Implement
        0.0
    }
}
