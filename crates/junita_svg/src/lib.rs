//! SVG loading and rendering for Junita
//!
//! This crate provides SVG file loading and conversion to Junita drawing primitives.
...
//!
//! ```ignore
//! use junita_svg::{SvgDocument, RasterizedSvg};
//!
