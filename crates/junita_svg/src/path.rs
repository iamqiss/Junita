//! SVG path conversion to Junita Path

use junita_core::{Path, PathCommand, Point};

/// Convert usvg path data to Junita Path
pub fn usvg_path_to_junita(path_data: &usvg::tiny_skia_path::Path) -> Path {
