...
SVG loading and rendering for Junita UI.

## Overview

`junita_svg` provides SVG parsing and rendering capabilities using [usvg](https://github.com/RazrFalcon/resvg) and [resvg](https://github.com/RazrFalcon/resvg).
