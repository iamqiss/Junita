...
impl TextArea {
    ...
    fn build_content(
        ...
        let cursor_canvas_opt = if is_focused {
            ...
            let cursor_canvas = canvas(
                move |ctx: &mut dyn junita_core::DrawContext,
                    ...
                    ctx.fill_rect(
                        junita_core::Rect::new(0.0, 0.0, cs.width, bounds.height),
                        junita_core::CornerRadius::default(),
                        junita_core::Brush::Solid(color),
                    );
                },
            )
            .absolute()
    ...
    pub fn bg(mut self, color: impl Into<junita_core::Brush>) -> Self {
    ...
    pub fn border(mut self, width: f32, color: junita_core::Color) -> Self {
        self.inner = std::mem::take(&mut self.inner).border(width, color);
        self
    }

    pub fn border_color(mut self, color: junita_core::Color) -> Self {
    ...
    pub fn shadow(mut self, shadow: junita_core::Shadow) -> Self {
    ...
    pub fn transform(mut self, transform: junita_core::Transform) -> Self {
