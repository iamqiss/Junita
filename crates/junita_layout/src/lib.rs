...
// Recorder bridge for event capture (junita_recorder integration)
...
pub mod prelude {
    ...
    // Re-export Shadow, Transform, and layer effect types from junita_core for convenience
    pub use junita_core::{BlurQuality, BlurStyle, LayerEffect, Shadow, Transform};
    ...
    // Re-export animation types from junita_animation for convenience
    ...
    pub use junita_core::{AnimationAccess, DynFloat, DynValue, ReactiveAccess, ValueContext};
