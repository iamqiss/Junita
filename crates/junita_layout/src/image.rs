...
use junita_core::{Brush, Color, Shadow, Transform};
use taffy::prelude::*;
...
// ============================================================================
// Object Fit (mirroring junita_image for layout purposes)
// ============================================================================
...
impl Image {
    ...
    /// # Example
    /// ```ignore
    /// use junita_core::{Brush, Gradient, GradientStop};
    ///
...
impl ElementBuilder for Image {
    ...
    fn render_props(&self) -> RenderProps {
        RenderProps {
            background: None,
            border_radius: junita_core::CornerRadius::uniform(self.border_radius),
