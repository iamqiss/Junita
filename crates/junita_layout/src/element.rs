...
/// Convert from junita_core::Shadow to MaterialShadow
...
impl MotionKeyframe {
    ...
    /// Create from junita_animation KeyframeProperties
    pub fn from_keyframe_properties(props: &junita_animation::KeyframeProperties) -> Self {
        Self {
...
impl MotionAnimation {
    ...
    pub fn from_enter_animation(
        anim: &junita_animation::MultiKeyframeAnimation,
        delay_ms: u32,
    ) -> Self {
    ...
    /// Add exit animation
    pub fn with_exit_animation(mut self, anim: &junita_animation::MultiKeyframeAnimation) -> Self {
...
///
/// ```ignore
/// use junita_layout::element::BorderBuilder;
