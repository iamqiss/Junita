...
use junita_animation::{AnimationScheduler, SchedulerHandle, Spring, SpringConfig, SpringId};
use junita_core::context_state::MotionAnimationState;
use junita_core::{Color, Rect, Transform};
...
/// Set by RenderState on initialization, used by junita_cn components.
...
impl RenderState {
    ...
    pub fn get_stable_motion_state(
        &self,
        key: &str,
    ) -> junita_core::context_state::MotionAnimationState {
        use junita_core::context_state::MotionAnimationState;
