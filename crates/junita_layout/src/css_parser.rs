...
//! stylesheet-based styling for Junita applications.
//!
//! # Error Handling
//!
...
//!
//! ```ignore
//! use junita_layout::css_parser::{Stylesheet, ParseResult as CssParseResult};
//!
//! let css = r#"
//!     #card {
...
impl CssKeyframes {
    ...
    /// Convert to Junita MotionAnimation for enter animations
    ///
    ...
    /// Convert to Junita MotionAnimation for exit animations
    ///
    ...
    ) -> junita_animation::MultiKeyframeAnimation {
        use junita_animation::MultiKeyframeAnimation;
    ...
    fn style_to_keyframe_properties(style: &ElementStyle) -> junita_animation::KeyframeProperties {
        use junita_animation::KeyframeProperties;
...
fn parse_theme_shadow<'a, E: NomParseError<&'a str>>(
    ...
    let shadow: junita_core::Shadow = match token_name.to_lowercase().replace('_', "-").as_str() {
...
fn parse_linear_gradient(input: &str) -> Option<Gradient> {
    ...
    Some(Gradient::Linear {
        ...
        spread: junita_core::GradientSpread::Pad,
    })
}
