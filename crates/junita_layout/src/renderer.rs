...
///
/// Used by `JUNITA_DEBUG=motion` to display animation stats.
...
impl RenderTree {
            ...
            if let Some(string_id) = self.element_registry.get_id(*node_id) {
                if let Some(bounds) = self.get_bounds(*node_id) {
                    self.element_registry.update_bounds(
                        &string_id,
                        junita_core::Bounds::new(bounds.x, bounds.y, bounds.width, bounds.height),
                    );
                }
            }
        }
    ...
    pub fn dispatch_event(
        &mut self,
        node_id: LayoutNodeId,
        event_type: junita_core::events::EventType,
        mouse_x: f32,
        mouse_y: f32,
    ) {
    ...
    pub fn dispatch_event_full(
        ...
        if event_type == junita_core::events::event_types::PINCH {
    ...
    pub fn dispatch_text_input_event(
        ...
        let ctx = crate::event_handler::EventContext::new(
            junita_core::events::event_types::TEXT_INPUT,
            node_id,
        )
        ...
        if self
            .handler_registry
            .has_handler(node_id, junita_core::events::event_types::TEXT_INPUT)
        {
            self.handler_registry.dispatch(&ctx);
    ...
    pub fn dispatch_text_input_event_bubbling(
        ...
        let event_type = junita_core::events::event_types::TEXT_INPUT;
    ...
    pub fn broadcast_text_input_event(
        ...
        self.handler_registry
            .broadcast(junita_core::events::event_types::TEXT_INPUT, &ctx);
    }
    ...
    pub fn dispatch_scroll_event(
        ...
        let ctx = crate::event_handler::EventContext::new(
            junita_core::events::event_types::SCROLL,
            node_id,
        )
        .with_mouse_pos(mouse_x, mouse_y)
        ...
        let has_handler = self
            .handler_registry
            .has_handler(node_id, junita_core::events::event_types::SCROLL);
    ...
    pub fn dispatch_pinch_chain(
        ...
        let event_type = junita_core::events::event_types::PINCH;
    ...
    fn render_layer_with_motion(
        ...
        if should_push_layer {
            ctx.push_layer(LayerConfig {
                id: None,
                position: Some(junita_core::Point::new(bounds.x, bounds.y)),
                size: Some(junita_core::Size::new(bounds.width, bounds.height)),
