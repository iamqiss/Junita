...
Procedural macros for Junita UI.

## Overview

`junita_macros` provides derive macros for generating boilerplate code in Junita applications.
...
The `JunitaComponent` derive generates:
