...
echo "  cargo build --target aarch64-linux-android -p junita_platform_android   # ARM64 (most devices)"
echo "  cargo build --target armv7-linux-androideabi -p junita_platform_android # ARMv7 (older 32-bit)"
echo "  cargo build --target x86_64-linux-android -p junita_platform_android    # x86_64 (emulator)"
echo "  cargo build --target i686-linux-android -p junita_platform_android      # x86 (old emulator)"
