...
// Opaque type for the Junita render context
...
///
/// This registers the Rust UI builder. Must be called before junita_create_context.
...
/// the frame for rendering. Call this each frame when junita_needs_render() is true.
///
/// @param ctx Render context pointer
...
///
/// @param ctx Render context pointer from junita_create_context
...
uint32_t junita_load_bundled_font(IOSGpuRenderer* gpu, const char* path);

/// Free a string allocated by Rust
void junita_free_string(char* ptr);

#endif /* Junita_Bridging_Header_h */
